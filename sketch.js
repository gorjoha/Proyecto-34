...
function setup() {
  ...
  box25 = new Box(745,100,70,70);
  box26 = new Box(745,100,70,70);
  box27 = new Box(745,100,70,70);
  box28 = new Box(745,100,70,70);
  box29 = new Box(745,100,70,70);

  box30 = new Box(820,100,70,70);
  box31 = new Box(820,100,70,70);
  box32 = new Box(820,100,70,70);
  box33 = new Box(820,100,70,70);
  box34 = new Box(820,100,70,70);
  box35 = new Box(820,100,70,70);

  box36 = new Box(600,100,70,70);
  box37 = new Box(600,100,70,70);
  box38 = new Box(600,100,70,70);
  box39 = new Box(600,100,70,70);

  box40 = new Box(900,100,70,70);
